...
{
    $path = '.' . DIRECTORY_SEPARATOR . 'components' . DIRECTORY_SEPARATOR . $className . '.php';
...
$studentOne = new Student('Константин', 'Музыка', 'Веб-разработка', '2', 'Веб-разработчик', '8-800-555-35-35');
$studentTwo = new Student('Андрей', 'Балконский', 'ИТ', '2', 'Веб-разработчик', '8-900-555-55-65');
$carOne = new Car('Niva', 'Urban', 'Чёрный', '1.6', '1 000 000 р');
